...
![\theta](https://latex.codecogs.com/svg.latex?%5Ctheta "\theta") is a
function of ![\mu](https://latex.codecogs.com/svg.latex?%5Cmu "\mu"),
and ![\phi](https://latex.codecogs.com/svg.latex?%5Cphi "\phi") is a
function of the nuisance parameter.
